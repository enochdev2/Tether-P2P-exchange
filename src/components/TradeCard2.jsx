...
const TradeCard2 = ({ offer }) => {
  ...
  return (
    <div className="flex items-center justify-between bg-white rounded-md p-4 mb-3 border border-gray-200">
      {/* Left Section */}
      <div className="flex flex-1 items-center w-24 mr-6">
        <div className="flex flex-1">
          <div className="b text-gray-500 font-bold text-lg px-3 py-1 rounded">
            {offer.statusDate}
          </div>
          <div className="b text-gray-600 font-bold text-lg px-3 py-1 rounded">
            {offer.statusTime}
          </div>
      ...
      {/* Middle Section */}
      <div className="flex-1 flex font-semibold text-lg text-gray-900">
       <span className="mr-2">
      ...
      {/* Right Section */}
      <div className="flex flex-1 justify-end w-32">
